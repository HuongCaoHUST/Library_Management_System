...
public class BorrowSlipListController {
    ...
    public void initialize() {
        ...
        addDetailButtonToTable(); // Add this call
        borrowSlipTable.setItems(borrowSlipList);
        loadBorrowSlips(); // Add this call
    }
    ...
    private void loadBorrowSlips() {
        try {
            ApiResponse<List<BorrowSlipResponse>> response = borrowSlipApiService.getAllBorrowSlips(); // Changed to getAllBorrowSlips
