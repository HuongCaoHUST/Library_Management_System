...
public class DocumentApiService {
    ...
    public List<Document> filterDocuments(String title, String author, String publisher, String documentType, String category, Integer publicationYear) throws Exception {
        String url = BASE_URL;
        ...
        if (category != null && !category.isEmpty()) query.append("category=").append(URLEncoder.encode(category, "UTF-8")).append("&");
